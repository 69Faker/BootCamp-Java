...
public class MainMenu
{
    ...
    public void execute() throws SQLException
    {
        ...
        // Loop infinito do menu principal - só encerra com System.exit(0)
        while (true) {
    ...
    private void createBoard() throws SQLException
    {
        ...
        // Criação da coluna inicial obrigatória
        System.out.println("Informe o nome da coluna inicial do board");
        var initialColumnName = scanner.next();
        var initialColumn = createColumn(initialColumnName, INITIAL, 0);
        columns.add(initialColumn);

        // Criação dinâmica de colunas adicionais do tipo PENDING
        ...
        // Associação das colunas ao board e persistência no banco
    ...
    private void selectBoard() throws SQLException
    {
        ...
        try (var connection = getConnection()) {
            ...
            // Uso de Optional para evitar NullPointerException ao consultar board
    ...
    private void deleteBoard() throws SQLException
    {
        ...
        try (var connection = getConnection()) {
            ...
            // delete retorna boolean -> confirma se o board existia ou não
    ...
    // Método auxiliar para criar uma coluna de forma genérica (evita duplicação de código)
